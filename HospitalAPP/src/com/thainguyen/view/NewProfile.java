...
import com.thainguyen.model.BenhNhan_;
...
public class NewProfile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Số bảo hiểm Y tế :");

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setText("HỒ SƠ BỆNH NHÂN");

        jButton1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jButton1.setText("Tạo mới hồ sơ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        benhnhan.setTen(jTextField1.getText());
        benhnhan.setId(Integer.parseInt(jTextField2.getText()));
        benhnhan.setNgaySinh(jTextField3.getText());
        benhnhan.setDiaChi(jTextField4.getText());
        benhnhan.setSoBh(jTextField5.getText());
        try {
            benhnhanDAO.createNewProfile(benhnhan);
            int hoso_id = hosoDAO.createNewFile(benhnhan.getId());
